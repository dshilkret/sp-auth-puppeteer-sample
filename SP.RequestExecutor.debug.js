...
SP.ProxyWebRequestExecutorInternal.processSuccessCallback = function SP_ProxyWebRequestExecutorInternal$processSuccessCallback$st(executor, responseInfo) {
    executor.$1W_1(responseInfo);
};
SP.ProxyWebRequestExecutorInternal.processErrorCallback = function SP_ProxyWebRequestExecutorInternal$processErrorCallback$st(executor, responseInfo, errorCode, errorMessage) {
    executor.$1V_1(responseInfo, errorCode, errorMessage);
};
SP.ProxyWebRequestExecutor = function SP_ProxyWebRequestExecutor(url, options) {
...
SP.ProxyWebRequestExecutor.prototype = {
    ...
    $1B_1: false,
    $8_1: null,
    get_aborted: function SP_ProxyWebRequestExecutor$get_aborted$in() {
        return this.$19_1;
    },
    get_responseAvailable: function SP_ProxyWebRequestExecutor$get_responseAvailable$in() {
        return !!this.$8_1 && this.$8_1.responseAvailable;
    },
    get_responseData: function SP_ProxyWebRequestExecutor$get_responseData$in() {
        if (!this.$8_1) {
            return null;
        }
        return this.$8_1.body;
    },
    get_started: function SP_ProxyWebRequestExecutor$get_started$in() {
        return this.$1B_1;
    },
    get_statusCode: function SP_ProxyWebRequestExecutor$get_statusCode$in() {
        if (!this.$8_1) {
            return 0;
        }
        return this.$8_1.statusCode;
    },
    get_statusText: function SP_ProxyWebRequestExecutor$get_statusText$in() {
        if (!this.$8_1) {
            return null;
        }
        return this.$8_1.statusText;
    },
    get_timedOut: function SP_ProxyWebRequestExecutor$get_timedOut$in() {
        return this.$1C_1;
    },
    get_xml: function SP_ProxyWebRequestExecutor$get_xml$in() {
        return null;
    },
    abort: function SP_ProxyWebRequestExecutor$abort$in() {
        this.$19_1 = true;
    },
    executeRequest: function SP_ProxyWebRequestExecutor$executeRequest$in() {
    ...
    $1W_1: function SP_ProxyWebRequestExecutor$$1W_1$in($p0) {
        this.$8_1 = $p0;
        (this.get_webRequest()).completed(Sys.EventArgs.Empty);
    },
    $1V_1: function SP_ProxyWebRequestExecutor$$1V_1$in($p0, $p1, $p2) {
    ...
    getAllResponseHeaders: function SP_ProxyWebRequestExecutor$getAllResponseHeaders$in() {
        if (!this.$8_1) {
            return null;
        }
        return this.$8_1.allResponseHeaders;
    },
    getResponseHeader: function SP_ProxyWebRequestExecutor$getResponseHeader$in(header) {
        ...
        return this.$8_1.headers[header.toUpperCase()];
    }
};
...
SP.ProxyWebRequestExecutorFactory.prototype = {
    $A_0: null,
    $7_0: null,
    createWebRequestExecutor: function SP_ProxyWebRequestExecutorFactory$createWebRequestExecutor$in() {
...
SP.RequestExecutor.getLoginUrl = function SP_RequestExecutor$getLoginUrl$st(returnUrl, appWebUrl, signInWebUrl) {
...
SP.RequestExecutor.$b = function SP_RequestExecutor$$b$st($p0, $p1) {
...
SP.RequestExecutor.$U = function SP_RequestExecutor$$U$st($p0) {
    SP.RequestExecutorUtility.$X($p0, 'url');
    return SP.RequestExecutorInternalSharedUtility.$U($p0);
};
SP.RequestExecutor.$t = function SP_RequestExecutor$$t$st($p0) {
    if (SP.RequestExecutor.$l[$p0]) {
        return document.getElementById('SPRequestExecutor' + $p0);
    }
    return null;
};
SP.RequestExecutor.$1h = function SP_RequestExecutor$$1h$st($p0, $p1, $p2) {
...
SP.RequestExecutor.$1S = function SP_RequestExecutor$$1S$st($p0, $p1) {
...
SP.RequestExecutor.$1N = function SP_RequestExecutor$$1N$st($p0, $p1, $p2, $p3, $p4) {
...
SP.RequestExecutor.$c = function SP_RequestExecutor$$c$st($p0, $p1, $p2) {
    if ($p0.error) {
...
SP.RequestExecutor.$q = function SP_RequestExecutor$$q$st() {
...
SP.RequestExecutor.$1g = function SP_RequestExecutor$$1g$st() {
...
SP.RequestExecutor.$F = function SP_RequestExecutor$$F$st($p0) {
...
SP.RequestExecutor.internalProcessIFrameOnload = function SP_RequestExecutor$internalProcessIFrameOnload$st(appWebProxyUrl) {
...
SP.RequestExecutor.$1b = function SP_RequestExecutor$$1b$st($p0) {
...
SP.RequestExecutor.$1x = function SP_RequestExecutor$$1x$st($p0, $p1) {
...
SP.RequestExecutor.$1Z = function SP_RequestExecutor$$1Z$st($p0) {
...
SP.RequestExecutor.$1v = function SP_RequestExecutor$$1v$st($p0) {
    var $v_0 = $p0;
...
SP.RequestExecutor.$1F = function SP_RequestExecutor$$1F$st($p0, $p1) {
...
SP.RequestExecutor.$z = function SP_RequestExecutor$$z$st($p0) {
    var $v_0 = SP.RequestExecutor.$P[$p0];
...
SP.RequestExecutor.$1w = function SP_RequestExecutor$$1w$st($p0) {
...
SP.RequestExecutor.$1K = function SP_RequestExecutor$$1K$st($p0) {
...
SP.RequestExecutor.internalProcessIFrameRequestTimeoutCallback = function SP_RequestExecutor$internalProcessIFrameRequestTimeoutCallback$st(postMessageId) {
    if (!SP.RequestExecutor.$4) {
        return;
    }
...
SP.RequestExecutor.internalProcessXMLHttpRequestTimeoutCallback = function SP_RequestExecutor$internalProcessXMLHttpRequestTimeoutCallback$st(xhr, requestInfo) {
...
SP.RequestExecutor.internalProcessXMLHttpRequestOnreadystatechange = function SP_RequestExecutor$internalProcessXMLHttpRequestOnreadystatechange$st(xhr, requestInfo, timeoutId) {
    if (xhr.readyState === 4) {
        if (timeoutId) {
...
SP.RequestExecutor.internalOnMessage = function SP_RequestExecutor$internalOnMessage$st(e) {
...
SP.RequestExecutor.get_$y = function SP_RequestExecutor$get_$y$st() {
    return !!document.body || SP.RequestExecutor.$1H;
};
SP.RequestExecutor.$x = function SP_RequestExecutor$$x$st($p0, $p1) {
...
SP.RequestExecutor.internalProcessWindowLoad = function SP_RequestExecutor$internalProcessWindowLoad$st() {
...
SP.RequestExecutor.$u = function SP_RequestExecutor$$u$st() {
...
SP.RequestExecutor.$1X = function SP_RequestExecutor$$1X$st($p0) {
...
SP.RequestExecutor.$1e = function SP_RequestExecutor$$1e$st($p0) {
...
SP.RequestExecutor.$23 = function SP_RequestExecutor$$23$st($p0) {
    if (SP.RequestExecutorUtility.$0($p0)) {
...
SP.RequestExecutor.$1m = function SP_RequestExecutor$$1m$st($p0, $p1) {
    var $v_0 = $p0;
...
SP.RequestExecutor.internalLoginButtonHandler = function SP_RequestExecutor$internalLoginButtonHandler$st(panelId) {
...
SP.RequestExecutor.internalCancelButtonHandler = function SP_RequestExecutor$internalCancelButtonHandler$st(panelId) {
    var $v_0 = SP.RequestExecutorNotificationPanel.$1Q(panelId);
...
SP.RequestExecutor.$1 = function SP_RequestExecutor$$1$st($p0) {
    var $v_0 = new Date();
...
SP.RequestExecutor.$1u = function SP_RequestExecutor$$1u$st($p0) {
    var $v_0 = document.createElement('DIV');

    $v_0.innerHTML = SP.RequestExecutorUtility.$i($p0);
    (SP.RequestExecutor.$1p()).appendChild($v_0);
};
SP.RequestExecutor.$1p = function SP_RequestExecutor$$1p$st() {
...
SP.RequestExecutor.prototype = {
    ...
    $O_0: 0,
    $7_0: null,
    get_formDigestHandlingEnabled: function SP_RequestExecutor$get_formDigestHandlingEnabled$in() {
        return this.formDigestHandlingEnabled;
    },
    set_formDigestHandlingEnabled: function SP_RequestExecutor$set_formDigestHandlingEnabled$in(value) {
        this.formDigestHandlingEnabled = value;
        return value;
    },
    get_iFrameSourceUrl: function SP_RequestExecutor$get_iFrameSourceUrl$in() {
        return this.iFrameSourceUrl;
    },
    set_iFrameSourceUrl: function SP_RequestExecutor$set_iFrameSourceUrl$in(value) {
        this.iFrameSourceUrl = value;
        return value;
    },
    get_$p_0: function SP_RequestExecutor$get_$p_0$in() {
    ...
    executeAsync: function SP_RequestExecutor$executeAsync$in(requestInfo) {
    ...
    initializeAsync: function SP_RequestExecutor$initializeAsync$in(success, error) {
        SP.RequestExecutor.$q();
    ...
    attemptLogin: function SP_RequestExecutor$attemptLogin$in(returnUrl, success, error) {
        SP.RequestExecutorUtility.$X(returnUrl, 'returnUrl');
    ...
    $14_0: function SP_RequestExecutor$$14_0$in($p0, $p1) {
        SP.RequestExecutor.$m++;
        var $v_0 = new SP.AppWebProxyRequestInfo();
    ...
    $1i_0: function SP_RequestExecutor$$1i_0$in($p0) {
    ...
    $1O_0: function SP_RequestExecutor$$1O_0$in($p0, $p1) {
    ...
    $1j_0: function SP_RequestExecutor$$1j_0$in($p0) {
        var $v_0 = SP.RequestExecutor.$b(this.$A_0, '_api/contextinfo');
    ...
    $13_0: function SP_RequestExecutor$$13_0$in() {
...
SP.RequestExecutorXHR.prototype = {
    ...
    $D_0: null,
    $w_0: null,
    open: function SP_RequestExecutorXHR$open$in(method, url) {
        this.$D_0.method = method;
        this.$D_0.url = url;
    },
    setRequestHeader: function SP_RequestExecutorXHR$setRequestHeader$in(header, value) {
    ...
    send: function SP_RequestExecutorXHR$send$in(body) {
        this.$D_0.body = body;
        if (this.timeout) {
    ...
    getResponseHeader: function SP_RequestExecutorXHR$getResponseHeader$in(header) {
        if (!this.readyState || this.readyState === 1) {
            return null;
        }
        return this.$w_0.headers[header.toUpperCase()].toString();
    },
    getAllResponseHeaders: function SP_RequestExecutorXHR$getAllResponseHeaders$in() {
        if (!this.readyState || this.readyState === 1) {
            return null;
        }
        return this.$w_0.allResponseHeaders;
    },
    $1W_0: function SP_RequestExecutorXHR$$1W_0$in($p0) {
        this.$1U_0($p0);
    },
    $1V_0: function SP_RequestExecutorXHR$$1V_0$in($p0, $p1, $p2) {
        this.$1U_0($p0);
    },
    $1J_0: function SP_RequestExecutorXHR$$1J_0$in() {
        if (this.onreadystatechange) {
            this.onreadystatechange();
        }
    },
    $1U_0: function SP_RequestExecutorXHR$$1U_0$in($p0) {
...
SP.RequestExecutorInternalSharedUtility.$U = function SP_RequestExecutorInternalSharedUtility$$U$st($p0) {
    var $v_0 = $p0.indexOf('://');
...
SP.RequestExecutorInternalSharedUtility.$1r = function SP_RequestExecutorInternalSharedUtility$$1r$st($p0) {
...
SP.RequestExecutorInternalSharedUtility.$1M = function SP_RequestExecutorInternalSharedUtility$$1M$st($p0) {
    var $v_0 = null;
...
SP.RequestExecutorInternalSharedUtility.$1L = function SP_RequestExecutorInternalSharedUtility$$1L$st($p0) {
    var $v_0 = '';
...
SP.RequestExecutorInternalSharedUtility.$1d = function SP_RequestExecutorInternalSharedUtility$$1d$st($p0) {
...
SP.RequestExecutorMessageProcessor.$F = function SP_RequestExecutorMessageProcessor$$F$st($p0, $p1) {
...
SP.RequestExecutorMessageProcessor.$1c = function SP_RequestExecutorMessageProcessor$$1c$st($p0, $p1) {
    if (SP.RequestExecutorMessageProcessor.$C) {
        if (SP.RequestExecutorMessageProcessor.$C.requestHeaders) {
            var $$dict_3 = SP.RequestExecutorMessageProcessor.$C.requestHeaders;
...
SP.RequestExecutorMessageProcessor.$1n = function SP_RequestExecutorMessageProcessor$$1n$st($p0) {
...
SP.RequestExecutorMessageProcessor.$16 = function SP_RequestExecutorMessageProcessor$$16$st($p0) {
    var $v_0 = $p0;
    var $v_1;
...
SP.RequestExecutorMessageProcessor.init = function SP_RequestExecutorMessageProcessor$init$st(settings) {
...
SP.RequestExecutorMessageProcessor.internalOnMessage = function SP_RequestExecutorMessageProcessor$internalOnMessage$st(e) {
...
SP.RequestExecutorMessageProcessor.$n = function SP_RequestExecutorMessageProcessor$$n$st($p0, $p1, $p2, $p3) {
...
SP.RequestExecutorMessageProcessor.prototype = {
    ...
    $L_0: 0,
    $5_0: null,
    $1Y_0: function SP_RequestExecutorMessageProcessor$$1Y_0$in() {
    ...
    $1k_0: function SP_RequestExecutorMessageProcessor$$1k_0$in() {
    ...
    $1l_0: function SP_RequestExecutorMessageProcessor$$1l_0$in($p0) {
        if ($p0.status !== 200) {
            var $v_5 = this.$h_0($p0);
    ...
    $h_0: function SP_RequestExecutorMessageProcessor$$h_0$in($p0) {
        var $v_0 = new SP.PostMessageResponseInfo();
    ...
    $18_0: function SP_RequestExecutorMessageProcessor$$18_0$in($p0) {
    ...
    $21_0: function SP_RequestExecutorMessageProcessor$$21_0$in() {
        if (this.$5_0) {
    ...
    $20_0: function SP_RequestExecutorMessageProcessor$$20_0$in() {
...
SP.RequestExecutorNotificationPanel.$22 = function SP_RequestExecutorNotificationPanel$$22$st($p0) {
...
SP.RequestExecutorNotificationPanel.$1Q = function SP_RequestExecutorNotificationPanel$$1Q$st($p0) {
    if (SP.RequestExecutorNotificationPanel.$M) {
        var $$dict_2 = SP.RequestExecutorNotificationPanel.$M;
...
SP.RequestExecutorNotificationPanel.$1E = function SP_RequestExecutorNotificationPanel$$1E$st($p0) {
...
SP.RequestExecutorNotificationPanel.$1y = function SP_RequestExecutorNotificationPanel$$1y$st($p0) {
    if (SP.RequestExecutorNotificationPanel.$M) {
        var $v_0 = SP.RequestExecutorNotificationPanel.$M[$p0];
...
SP.RequestExecutorNotificationPanel.$1I = function SP_RequestExecutorNotificationPanel$$1I$st($p0, $p1) {
...
SP.RequestExecutorNotificationPanel.$1t = function SP_RequestExecutorNotificationPanel$$1t$st() {
...
SP.RequestExecutorNotificationPanel.$1o = function SP_RequestExecutorNotificationPanel$$1o$st() {
...
SP.RequestExecutorNotificationPanel.$1s = function SP_RequestExecutorNotificationPanel$$1s$st() {
...
SP.RequestExecutorNative.$$cctor = function SP_RequestExecutorNative$$$cctor$st() {
    SP.RequestExecutorNative.emptyCallback = function() {
    };
};
SP.RequestExecutorNative.getIFrameOnloadCallback = function SP_RequestExecutorNative$getIFrameOnloadCallback$st(appWebProxyUrl) {
    return function() {
        SP.RequestExecutor.internalProcessIFrameOnload(appWebProxyUrl);
    };
};
SP.RequestExecutorNative.getXMLHttpRequestOnreadystatechangeCallback = function SP_RequestExecutorNative$getXMLHttpRequestOnreadystatechangeCallback$st(req, requestInfo, timeoutId) {
    return function() {
        SP.RequestExecutor.internalProcessXMLHttpRequestOnreadystatechange(req, requestInfo, timeoutId);
    };
};
SP.RequestExecutorNative.getXMLHttpRequestTimeoutCallback = function SP_RequestExecutorNative$getXMLHttpRequestTimeoutCallback$st(req, requestInfo) {
    return function() {
        SP.RequestExecutor.internalProcessXMLHttpRequestTimeoutCallback(req, requestInfo);
    };
};
SP.RequestExecutorNative.getIFrameRequestTimeoutCallback = function SP_RequestExecutorNative$getIFrameRequestTimeoutCallback$st(postMessageId) {
    return function() {
        SP.RequestExecutor.internalProcessIFrameRequestTimeoutCallback(postMessageId);
    };
};
SP.RequestExecutorNative.getProxyWebRequestExecutorSuccessCallback = function SP_RequestExecutorNative$getProxyWebRequestExecutorSuccessCallback$st(executor) {
    return function($p1_0) {
        SP.ProxyWebRequestExecutorInternal.processSuccessCallback(executor, $p1_0);
    };
};
SP.RequestExecutorNative.getProxyWebRequestExecutorErrorCallback = function SP_RequestExecutorNative$getProxyWebRequestExecutorErrorCallback$st(executor) {
    return function($p1_0, $p1_1, $p1_2) {
        SP.ProxyWebRequestExecutorInternal.processErrorCallback(executor, $p1_0, $p1_1, $p1_2);
    };
};
SP.RequestExecutorNative.trim = function SP_RequestExecutorNative$trim$st(str) {
    return str.replace(new RegExp('^\\s+|\\s+$', 'g'), '');
};
SP.RequestExecutorResources = function SP_RequestExecutorResources() {
};
SP.RequestExecutorResources.getString = function SP_RequestExecutorResources$getString$st(resourceId) {
    var $v_0 = null;
...
SP.RequestExecutorUtility.$2 = function SP_RequestExecutorUtility$$2$st($p0) {
    var $v_0 = null;

    return $p0 === $v_0 || typeof $p0 === 'undefined' || !$p0.length;
};
SP.RequestExecutorUtility.$0 = function SP_RequestExecutorUtility$$0$st($p0) {
    var $v_0 = null;

    return $p0 === $v_0 || typeof $p0 === 'undefined';
};
SP.RequestExecutorUtility.$9 = function SP_RequestExecutorUtility$$9$st($p0) {
    return typeof $p0 === 'undefined';
};
SP.RequestExecutorUtility.$T = function SP_RequestExecutorUtility$$T$st($p0) {
    var $p1 = [];
...
SP.RequestExecutorUtility.$1P = function SP_RequestExecutorUtility$$1P$st($p0, $p1, $p2) {
...
SP.RequestExecutorUtility.$G = function SP_RequestExecutorUtility$$G$st($p0) {
    var $v_0;
...
SP.RequestExecutorUtility.$X = function SP_RequestExecutorUtility$$X$st($p0, $p1) {
    if (!SP.RequestExecutorUtility.$1T($p0)) {
        throw SP.RequestExecutorUtility.$J($p1);
    }
};
SP.RequestExecutorUtility.$1T = function SP_RequestExecutorUtility$$1T$st($p0) {
    return ($p0.substr(0, 8)).toLowerCase() === 'https://' || ($p0.substr(0, 7)).toLowerCase() === 'http://';
};
SP.RequestExecutorUtility.$6 = function SP_RequestExecutorUtility$$6$st($p0, $p1, $p2, $p3) {
    if ($p3) {
...
SP.RequestExecutorUtility.$S = function SP_RequestExecutorUtility$$S$st($p0, $p1) {
...
SP.RequestExecutorUtility.$J = function SP_RequestExecutorUtility$$J$st($p0) {
...
SP.RequestExecutorUtility.$11 = function SP_RequestExecutorUtility$$11$st() {
...
SP.RequestExecutorUtility.$10 = function SP_RequestExecutorUtility$$10$st() {
...
SP.RequestExecutorUtility.$12 = function SP_RequestExecutorUtility$$12$st() {
...
SP.RequestExecutorUtility.$i = function SP_RequestExecutorUtility$$i$st($p0) {
...
SP.RequestExecutorUtility.$1R = function SP_RequestExecutorUtility$$1R$st($p0, $p1) {
    if (!$p0) {
        return null;
    }
    if (!$p1) {
...
SP.RequestExecutorUtility.$17 = function SP_RequestExecutorUtility$$17$st($p0, $p1) {
...
SP.RequestExecutorHttpUtility.$R = function SP_RequestExecutorHttpUtility$$R$st($p0, $p1, $p2) {
    var $v_0 = '';
    var $v_1;
    var $v_2 = 0;
    var $v_3 = ' \"%<>\'&';
